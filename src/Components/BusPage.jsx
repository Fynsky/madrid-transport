...
function BusPage(props) {
  ...
  const classNameBusPageMain = classNames(style.main, {
  ...
  return (
    <div className={style.mainBusPage}>
      <BusInput
        ...
        sizeUserSreen={sizeUserSreen}
        allStopsJson={allStopsJson}
        setValueOfStop={setValueOfStop}
      />
            ...
            <div className={style.divFavor}>
              <div className={style.divHeadingFavoriteList}>
                <div className={style.textMyFavoriteAndImageStar}>
                  <div className={style.textMyFavorite}>
                    {stringsPatterns['My favotites stops:'][lenguage]}
                  </div>
                  <div className={style.starDiv}>
                    <img
                      src={
                        showFavor ? (settings.screenTheme === 'dark' ? starEmptyWhite : starEmptyBlack) : star
                      }
                ...
                <div>
                  <button type="button" onClick={() => toogleSortArrayButton()} className="red button">
                    {' '}
                    {buttonNameSortArray}
                  </button>
                </div>
              ...
              {!doNeedSortArray ? (
                <FavoritesList myFavArr={myFavArr} settings={settings} />
              ) : (
                <SortableComponent items={myFavArr} settings={settings} setSortedArray={setSortedArray} />
              )}
            </div>
          ) : null}
