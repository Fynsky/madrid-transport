...
function ToogleFavorite({ isFavorStop, item, addFavorStop, removeFavorStop, settings }) {
    ...
    const classNameToogleFavoriteMain = classNames(
        style.divAddToFavor,
        {
        ...
        <div>
            <form>
                <div className={classNameToogleFavoriteMain}>
                    ...
                    <ModalFavor item={item} isFavorStop={isFavorStop} settings={settings}
                                addFavorStop={addFavorStop} removeFavorStop={removeFavorStop}/>
                </div>  
            </form>
        </div>
    )
