...
function MapingLine({ setSearchResultsForMapingThunkCreator, allStopsJson, searchResultsForMaping, ownProps }) {
    ...
    return <GoogleMaps searchResultsForMaping={searchResultsForMaping} showNav={showNav} setShowNav={setShowNav} />
}
